...
public class RunningData {
	...
	private static FastThreadLocal<String> localdate = new FastThreadLocal<String>(); // 时间
	...
	public static void setLocaldate(String localdate) {
		RunningData.localdate.set(localdate);
	}
